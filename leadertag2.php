...
$tampil=mysql_query("SELECT * FROM leader WHERE leader.leadername NOT IN ('MADI','PPIC','QUALITY')
 ORDER BY leadername ASC");

echo "<u><center><font size='+2'><b>PSI - STOCK TAKE MARCH 2017 INPUT TAG CONTROL</b></font></u><br><br><br>"; 
...
echo "<table border='1' width='100%'>
		<tr>
			...
			<th colspan='4'>Sen, 27 Mar 17</th>
			<th colspan='4'>Rab, 29 Mar 17</th>
			<th colspan='4'>Kam, 30 Mar 17</th>
...
while ($data = mysql_fetch_array($tampil))
		{
			...
			echo "<tr>
				<td>$data[leadername] ($data[StRack])</td>";
			...
			stoktaking.last_date<='2017-03-27 13:00:00' AND 
			...
			INNER JOIN leader ON leader.StRack=stoktaking.StRack
			WHERE leader.leadername='$data[leadername]' AND 
			stoktaking.last_date>='2017-03-27 13:00:01' AND 
			stoktaking.last_date<='2017-03-27 16:30:00' AND 
			stoktaking.last_date NOT IN ('0000-00-00 00:00:00')
			GROUP BY leader.leadername");
			...
			INNER JOIN leader ON leader.StRack=stoktaking.StRack
			WHERE leader.leadername='$data[leadername]' AND 
			stoktaking.last_date>='2017-03-27 16:30:01' AND 
			stoktaking.last_date<='2017-03-29 13:00:00' AND 
			stoktaking.last_date NOT IN ('0000-00-00 00:00:00')
			GROUP BY leader.leadername");
			...
			INNER JOIN leader ON leader.StRack=stoktaking.StRack
			WHERE leader.leadername='$data[leadername]' AND 
			stoktaking.last_date>='2017-03-29 13:00:01' AND 
			stoktaking.last_date<='2017-03-29 16:30:00' AND 
			stoktaking.last_date NOT IN ('0000-00-00 00:00:00')
			GROUP BY leader.leadername");
			...
			INNER JOIN leader ON leader.StRack=stoktaking.StRack
			WHERE leader.leadername='$data[leadername]' AND 
			stoktaking.last_date>='2017-03-29 16:30:01' AND 
			stoktaking.last_date<='2017-03-30 13:00:00' AND 
			stoktaking.last_date NOT IN ('0000-00-00 00:00:00')
			GROUP BY leader.leadername");
			...
			INNER JOIN leader ON leader.StRack=stoktaking.StRack
			WHERE leader.leadername='$data[leadername]' AND 
			stoktaking.last_date>='2017-03-30 13:00:01' AND 
			stoktaking.last_date<='2017-03-30 16:00:00' AND 
			stoktaking.last_date NOT IN ('0000-00-00 00:00:00')
			GROUP BY leader.leadername");
			...
			$totalpersen=$persen3+$persen4+$persen5+$persen6+$persen7+$persen8;
