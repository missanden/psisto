...
echo "<tr align='right'>
	...
	<td bgcolor='#fce5ff'>". round($qty_erp_result, 2)."</td>
	<td bgcolor='#fce5ff'>". round($amount_erp_result, 2)."</td>
	<td bgcolor='#e2fff3'>". round($qty_take_result, 2)."</td>
	<td bgcolor='#e2fff3'>". round($amount_take_result, 2)."</td>
	<td bgcolor='#fcdbb7'>". round($varqtyresult, 2)."</td>
	<td bgcolor='#fcdbb7'>". round($varamountresult, 2)."</td>
	<td bgcolor='#fcdbb7'>". round((100-$persentase_result)*(-1), 2)  ." %</td>
	<td bgcolor=''>". round($accuracystock, 2)  ." %</td>
	<td bgcolor=''>". round($excesvariance, 2)."</td>
	<td bgcolor=''>". round($shortvariance, 2)."</td>
	<td bgcolor=''>". round($gross, 2)."</td>
...
$totalaccuracystock=100-abs($persen);
	...
	<td><b>". round($total_qty_erp, 2)  ."</b></td>
	<td><b>". round($total_amount_erp, 2)  ."</b></td>
	<td><b>". round($total_qty_take, 2)  ."</b></td>
	<td><b>". round($total_amount_take, 2)  ."</b></td>
	<td><b>". round($total_qty_var, 2)  ."</b></td>
	<td><b>". round($total_amount_var, 2)  ."</b></td>
	<td><b>". round((100-$totalpersentase_result)*(-1), 2)  ." %</b></td>
	<td><b>". round($totalaccuracystock, 2)  ." %</b></td>
	<td><b>". round($total_excess_var, 2)  ."</b></td>
	<td><b>". round($total_short_var, 2)  ."</b></td>
	<td><b>". round($total_gross_var, 2)  ."</b></td>
	...
	echo "<tr>
	<td>Nett Amount</td>
	<td colspan='13' align='center'><font color='red'><b><i>". round($total_amount_var, 2)  ."</b></i></td>
	</tr>
...
$accuracywh=100-abs($persentase_wh);
	...
	echo "<tr align='right'>
		...
		<td bgcolor='#fce5ff'>". round($qty_erp_wh, 2)  ."</td>
		<td bgcolor='#fce5ff'>". round($amount_wh_erp, 2)  ."</td>
		<td bgcolor='#e2fff3'>". round($qty_take_wh, 2)  ."</td>
		<td bgcolor='#e2fff3'>". round($amount_take_wh, 2)  ."</td>
		<td bgcolor='#fcdbb7'>". round($varqtywh, 2)  ."</td>
		<td bgcolor='#fcdbb7'>". round($varamountwh, 2)  ."</td>
		<td bgcolor='#fcdbb7'>". round($persentase_wh*(-1), 2)  ." %</td>
		<td bgcolor=''>". round($accuracywh, 2)  ." %</td>
		<td bgcolor=''>". round($excesvariancewh, 2)  ."</td>
		<td bgcolor=''>". round($shortvariancewh, 2)  ."</td>
		<td bgcolor=''>". round($grosswh, 2)  ."</td>
