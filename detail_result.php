...
$tampil=mysql_query("SELECT * FROM data_erp INNER JOIN master_wh ON data_erp.warehouse=master_wh.StWh
		WHERE master_wh.group_wh='$wh'");
}
...
while ($data = mysql_fetch_array($tampil))
		{echo "<tr>
				...
				{
					$excesvariance=0;
					$shortvariance=$amountvariant;
					$gross=abs($amountvariant);
				}
				else {
					$excesvariance=$amountvariant;
					$shortvariance=0;
					$gross=abs($amountvariant);
					}
